...
🪢 Python (Numpy, Pandas, Matplotlib, Sklearn, OpenCV, Dlib, etc), HTML & CSS and Java!! <br>
🦾 3D Designer (Blender) & Hardware DIYer <br>
⚡ I aspire to become an engineer in Big Tech robotics & Perception/SLAM engineering & research. Currently working on computer vision research to build a competitive portfolio for college apps and a future career. <br>
